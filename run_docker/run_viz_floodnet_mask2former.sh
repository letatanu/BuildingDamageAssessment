...
docker run --rm -it -v /dev/shm:/dev/shm \
  ...
  bash -lc "
        ...
        python  \
        viz_mask2former.py --model /working/runs/mask2former_floodnet/checkpoint-13800 \
        --gt_folder /data/FloodNet-Supervised_v1.0/test/test-label-img \
        --image /data/FloodNet-Supervised_v1.0/test/test-org-img/7361.jpg \
        --outdir runs/mask2former_floodnet/viz/
        "